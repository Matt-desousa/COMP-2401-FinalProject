...
void initHunter(char* name, EvidenceType evidenceType, Room* startingRoom, EvidenceNode* sharedEvidenceList) {
    ...
    newHunter->shared_evidence_list = sharedEvidenceList;
